...
if a!="Evgeny":
    ...
    print(colored(f"Пароль верен! Запускаю работу программы!\nУдачи пользованием", 'green'))

# ASCII-арт приветствия
ascii_banner = pyfiglet.figlet_format("EvgenyReport")
colored_banner = colored(ascii_banner, color='green')  # Красим в цвет
